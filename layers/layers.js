...
lyr_GoogleSatellite_0.setVisible(true);lyr_pl_amphoe_1.setVisible(true);lyr_pl_stream_2.setVisible(true);lyr_pl_tambon_3.setVisible(true);lyr_pl_transportation_4.setVisible(true);lyr_pl_village_5.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_pl_amphoe_1,lyr_pl_stream_2,lyr_pl_tambon_3,lyr_pl_transportation_4,lyr_pl_village_5];
...
lyr_pl_transportation_4.set('fieldImages', {'LENGTH': '', 'TRANS_TYP': '', 'TYP_T': '', 'NAME_T': '', 'NAME_E': '', 'TranNo': '', 'TranTyp_n': '', });
